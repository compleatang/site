...
date: 2014-02-13
description: "Working with PDFs in Linux is not perfect. There is no one program to rule them all as Adobe has done with Acrobat in Windows and OSX. But there are good, viable solutions which can do almost everything that Acrobat will do."
tags:
  - "pdfs"
  - "linux"
  - "Linux for Lawyers"
